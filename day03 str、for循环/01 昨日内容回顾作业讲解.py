...
# print(1>1 or 3<4 or 4>5 and 2>1 and 9>8 or 7<6)
# print(T and T and T)  #TRUE

# print(not 2>1 and 3<4 or 4>5 and 2>1 and 9>8 or 7<6)
# print(F and F and T and T)  #FALSE

# print(1>2 and 3<4 or 4>5 and 2>1 or 9<8 and 4>6 or 3<2)#结果为FALSE
# print(F and T and T and F)  #结果为FALSE


# print(8 or 3 and 4 or 2 and 0 or 9 and 7)#结果为8
# print(8 or 4 or 0 or 7) #结果为8

# print(0 or 2 and 3 or 4 or 6 and 0 or 3)#结果为3
# print(0 or 3 or 4 or 0 or 3)#结果为3


# print(5 and 9 or 10 and 2 or 3 and 5 or 4 or 5)#结果为9
# print(9 or 2 or 5 or 4 or 5) #结果为9

#    2),0 or 2 and 3 and 4 or 6 and 0 or 3
# print(0 or 4 or 0 or 3) #结果为4
# 3. 下列结果是什么？
#    1)、6 or 2 > 1
# print(6 or 2 > 1)
#    2)、3 or 2 > 1
...
# print(2 or 2 < 3 and 3 and 4 or 3 > 2) #2
# 4. while循环语句基本结构？
# 5. 利用while语句写出猜大小的游戏：
